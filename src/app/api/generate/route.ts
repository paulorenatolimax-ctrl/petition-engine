...
const DOC_TYPE_PATTERNS: Record<string, string[]> = {
  ...
  testimony_letter_eb1a: ['GERAR_TESTEMUNHO_EB1_', 'GERAR_TESTIMONY_EB1A_'],
  testimony_letter_eb2_niw: ['GERAR_TESTEMUNHO_EB2_', 'GERAR_TESTIMONY_EB2_NIW_'],
  hr_declaration: ['GERAR_DECLARACAO_RH_', 'GERAR_HR_DECLARATION_'],
