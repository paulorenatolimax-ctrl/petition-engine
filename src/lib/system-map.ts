...
export const SYSTEM_MAP: Record<string, SystemConfig> = {
  ...
  rfe_response_eb1a: {
    name: 'Resposta a RFE — EB-1A',
    symlinkDir: 'rfe-eb1a-orchestrator',
    preferredModel: 'claude-opus-4',
    requiresProfile: true,
    requiresDeepResearch: false,
    outputFormat: 'docx',
  ...
  rfe_response_eb2_niw: {
    name: 'Resposta a RFE — EB-2 NIW',
    symlinkDir: 'rfe-eb2niw-orchestrator',
    preferredModel: 'claude-opus-4',
    requiresProfile: true,
    requiresDeepResearch: false,
    outputFormat: 'docx',
  ...
  /** @deprecated use rfe_response_eb1a; kept for backward compatibility with older generations */
  rfe_response: {
    name: 'Resposta a RFE (legacy alias → EB-1A)',
    symlinkDir: 'rfe-eb1a-orchestrator',
    preferredModel: 'claude-opus-4',
    requiresProfile: true,
    requiresDeepResearch: false,
