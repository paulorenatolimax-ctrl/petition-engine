...
| Headers de seção | 14pt bold, shading #D6E1DB, preto |
| Título critério | 13pt bold+italic, shading #D6E1DB, preto |
| Evidence title | 10pt bold, #2E7D32 (green) |
| Evidence block bg | #FFF8EE (cream) |
| Table headers | 10pt bold, shading #D6E1DB, preto |
...
8. **Fundo azul escuro (#1F3864) nos headers da capa** — Cores proibidas. CORRIGIDO: capa agora usa verde PROEX (#D6E1DB) conforme benchmark.
