...
## SUB-EVIDÊNCIAS — REGRA ATUALIZADA v5.0 (Lição Vitória)

> **ATENÇÃO — MUDANÇA IMPORTANTE**: O sistema de sub-evidências com sufixo (XXa, XXb) do v3.0/v4.0 foi **DESCONTINUADO**.

### REGRA v5.0:
CVs dos recomendadores, documentos complementares e originais em português são PARTE INTEGRANTE da evidência principal. NÃO recebem número separado.

**Exemplo**: A Evidência 68 (Carta de Recomendação de André Barroso Heibel) inclui TANTO a carta quanto o CV. Ambos são "Evidência 68". Não existe "Evidência 68a" nem "Evidência 68.1".

### No índice (Enclosed Evidence Guide):
```
Evidência 68. Carta de Recomendação — André Barroso Heibel (Clínica Scientia) + Curriculum Vitae
```

### No evidence block:
O bloco de metadados da Evidência 68 menciona que o CV está anexo. NÃO criar bloco separado para o CV.

### Motivação:
Paulo determinou que sub-numeração confunde e não existe na prática do escritório. Todo documento auxiliar é parte do mesmo número de evidência.

---

*v3.0 — 09/03/2026 — Adicionada convenção de sub-evidências com base nas lições do Caso Renato Silveira v19→v23.*
*v5.0 — 18/03/2026 — Sub-evidências descontinuadas (ATUALIZAÇÃO CRÍTICA do Caso Vitória Carolina).*
