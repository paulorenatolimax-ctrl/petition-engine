...
- **Tabelas**: Header com fundo `#D6E1DB` (verde PROEX) e texto preto bold, fonte 10pt. Bordas APENAS horizontais (NUNCA box borders)
...
12. **Capa = formato CARTA** (data à direita, To: USCIS, bloco metadata verde PROEX, "Dear USCIS Officer,") — NUNCA title page centrada.
