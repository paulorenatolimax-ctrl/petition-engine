...
## v3.0 — 18/03/2026 — Adaptado do EB-1A v5.0 para EB-2 NIW
...
Adaptado para EB-2 NIW com estrutura de Elegibilidade + 3 Prongs em lugar de Critério 1-10 + Step 1/2.
...
## ETAPA 6: QUEBRAS DE PÁGINA (EB-2 NIW)

### Adicionar pageBreakBefore APENAS em:
- **PRONG I** (antes da seção Prong I)
- **PRONG II** (antes da seção Prong II)
- **PRONG III** (antes da seção Prong III)
- **CONCLUSÃO** (antes da seção Conclusão)

### NÃO adicionar em:
- Sumário (Parte I)
- Elegibilidade
- Sub-seções internas (critérios específicos dentro de cada Prong, tabelas, notas)
- Introdução
...
### Garamond:
- Corpo: 12pt
- Títulos de Prong: 13pt bold italic
...
### Header:
"EB-2 NIW Petition — [Nome Completo]" (9pt, itálico, direita, cinza)

### Footer:
"EB-2 NIW | I-140 Petition — Cover Letter [NOME] | Page X of Y" (10pt, centralizado) — usar campos PAGE e NUMPAGES
...
| 4 | Page break em Elegibilidade ou sub-seções | Elegibilidade fica múltiplas páginas | Só em PRONG I/II/III/CONCLUSÃO (ALL CAPS) |
...
| 10 | Prong 2 ou 3 < 25% do total | Documento desequilibrado | Expandir antes de entregar |
