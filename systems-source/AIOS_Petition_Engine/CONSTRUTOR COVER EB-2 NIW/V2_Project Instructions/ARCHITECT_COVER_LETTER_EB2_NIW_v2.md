...
### v2.0 — 02/03/2026 (substitui v1.0 + PROTOCOLO_DE_INTERACAO v1.0)
...
**Ordem de leitura:**
```
1. SISTEMA_COVER_LETTER_EB2_NIW_v2.md (arquitetura)
...
6. RAGs de vacinação EB-2 NIW (Knowledge/project_knowledge)
7. Benchmarks (PDFs de cover letters anteriores)
8. TODOS os documentos do cliente na pasta
```
...
H Section: 14pt bold, shading #C5E0B4, black
H Sub: 13pt bold italic, #C5E0B4
Evidence title: 10pt bold #2E7D32
Evidence card bg: #FFF2CC (AMBAS células, ShadingType.CLEAR)
H4 subtitle: #F2F5D7 (light yellow — NÃO #F7F9EE)
Tables: horizontal borders ONLY, header #C5E0B4
