...
## Cliente: Gabriela Márcia Rodrigues
## Visto: EB-2-NIW
...
## DADOS DO CLIENTE
Pasta de documentos: /Users/paulo1844/Documents/_PROEX (A COMPLEMENTAR)/_1. APIÁRIO (QUARTA PARTE)/VALÉRIA/Gabriela Márcia Rodrigues 
...
## OUTPUT
Salve o arquivo .md em: /Users/paulo1844/Documents/_PROEX (A COMPLEMENTAR)/_1. APIÁRIO (QUARTA PARTE)/VALÉRIA/Gabriela Márcia Rodrigues /_Forjado por Petition Engine/
Nome: Projeto_Base_EB2_NIW_Gabriela_Márcia_Rodrigues.md
...
seguem os dados da cliente: Gabriela Márcia Rodrigues para construção do Projeto Base:

Código de Ocupação 11-9179.00 - Personal Service Managers, All Other

PROPOSED ENDEAVOR OPÇÃO A - Aroma Groom Pro Studio
