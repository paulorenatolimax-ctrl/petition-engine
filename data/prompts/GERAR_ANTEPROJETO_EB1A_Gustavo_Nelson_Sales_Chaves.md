# ANTEPROJETO EB-1A
## Cliente: Gustavo Nelson Sales Chaves
## Visto: EB-1A
...
## DADOS DO CLIENTE
Pasta de documentos: /Users/paulo1844/Documents/_PROEX (A COMPLEMENTAR)/_2. MEUS CASOS/2026/GUSTAVO NELSON/
Leia TODOS os documentos do cliente (CV, certificados, evidencias) ANTES de gerar.

## MODO ANTEPROJETO (EXECUCAO PARCIAL)
Execute APENAS os prompts 1-3 do sistema EB-1A (Kortix).
O output deve conter:
1. Mapeamento completo do perfil (10 categorias)
2. Analise detalhada dos 10 criterios EB-1A (forca: ROBUSTA/PROMISSORA/EM DESENVOLVIMENTO)
3. 3 codigos SOC/BLS alternativos com validacao
4. Quadro-resumo com endeavor proposto e criterios mais fortes

## OUTPUT
Salve o arquivo .md em: /Users/paulo1844/Documents/_PROEX (A COMPLEMENTAR)/_2. MEUS CASOS/2026/GUSTAVO NELSON/_Forjado por Petition Engine/
Nome: Anteprojeto_EB1A_Gustavo_Nelson_Sales_Chaves.md

## REGRAS DE ERRO ATIVAS (AUTO-LEARNING)
Total: 12 regras (12 globais + 0 especificas para anteprojeto_eb1a)
