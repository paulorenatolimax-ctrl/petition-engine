...
async function runSeed() {
  ...
  const systemsFull = [
    { system_name: 'cover-letter-eb1a', version_tag: '5.0.0', doc_type: 'cover_letter_eb1a', is_active: true, recommended_model: 'Claude Code', file_count: 23, system_path: '/Users/paulo1844/Documents/2_PROEX (A COMPLEMENTAR)/PROMPTs/_sistema cover auto/EB1A_SYSTEM_v5', changelog: 'Sistema original v5' },
    ...
    { system_name: 'resume-eb1a', version_tag: '1.0.0', doc_type: 'resume', is_active: true, recommended_model: 'Claude Code', file_count: 9, system_path: '/Users/paulo1844/Documents/2_PROEX (A COMPLEMENTAR)/PROMPTs/_sistema résumé auto/EB1A_RESUME_SYSTEM', changelog: 'Sistema de résumé EB-1A' },
    ...
    { system_name: 'estrategia-eb2', version_tag: '1.0.0', doc_type: 'strategy_eb2', is_active: true, recommended_model: 'Claude Code', file_count: 9, system_path: '/Users/paulo1844/Documents/2_PROEX (A COMPLEMENTAR)/PROMPTs/EB-2 - ESTRATÉGIAS', changelog: 'Estratégia EB-2 NIW' },
    { system_name: 'estrategia-eb1', version_tag: '1.0.0', doc_type: 'strategy_eb1', is_active: true, recommended_model: 'Claude Code', file_count: 11, system_path: '/Users/paulo1844/Documents/2_PROEX (A COMPLEMENTAR)/PROMPTs/EB-1 - ESTRATÉGIA EB-1 (PROMPTS)/_ASSISTENTE FINAL (ESTE)', changelog: 'Estratégia EB-1A' },
    { system_name: 'localizacao', version_tag: '1.0.0', doc_type: 'location_analysis', is_active: true, recommended_model: 'Claude Code', file_count: 1, system_path: '/Users/paulo1844/Documents/2_PROEX (A COMPLEMENTAR)/PROMPTs/LOCALIZAÇÃO - PROMPT', changelog: 'Análise de localização' },
  ];
